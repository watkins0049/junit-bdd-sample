...
// Not necessary for BDD-style tests, but something I like to add as a detail
...
public class PokemonServiceTests {
    ...
    // for the function pokemonById will be stored under this class. The @Nested annotation
    ...
    class PokemonByIdFunction {
        ...
        class GivenAPokedexEntryNumber {
            ...
            // constructed by appending each class name with the others ("$" delimited). Too many
